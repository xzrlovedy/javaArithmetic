 ...
 *
 * WeiqiFactory 是享元工厂角色，它通过 ArrayList 来管理棋子，
 * 并且提供了获取白子或者黑子的 getChessPieces(String type) 方法；
 *
 * 客户类（Chessboard）利用 Graphics 组件在框架窗体中绘制一个棋盘，
 * 并实现 mouseClicked(MouseEvent e) 事件处理方法，
